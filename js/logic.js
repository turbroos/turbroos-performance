(() => {
  /* =========================================================
     logic.js (NUR Logik / UI / Chart)
     Erwartet window.DB und window.OPTION_DEFS aus db.js
     ========================================================= */

  const OPTION_DEFS = window.OPTION_DEFS;
  const DB = window.DB;
  ...
  // Verdichtungsverhältnis (dein HTML hat spCompression)
  ...
  /* =========================================================
     ...
     ========================================================= */
  function init() {
    // Sicherheitscheck: wenn DB nicht geladen wurde, sieht man es sofort
    if (!DB || !OPTION_DEFS) {
      console.error("DB oder OPTION_DEFS fehlen. Prüfe, ob db.js VOR logic.js geladen wird.");
      return;
    }
